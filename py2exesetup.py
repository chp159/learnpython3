...
py2exe_options = {
        ...
        "bundle_files": 1,                       #值为1表示pyd和dll文件会被打包到单文件中，且不能从文件系统中加载python模块；# 值为2表示pyd和dll文件会被打包到单文件中，但是可以从文件系统中加载python模块
        }
...
setup(
      ...
      version = '1.0',
      console = [{'script':'TCPServer.py','icon_resources':[(0,'resource/2.ico')]},],     #设置程序名称与exe的图标
